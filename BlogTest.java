...
//		options.addArguments("--user-data-dir=C:\\Users\\user\\Desktop\\BURCH\\II semester");
	...
	void test() throws InterruptedException {
		...
		assertEquals("Big Data", text);
			
		Thread.sleep(3000);
		
		String url = webDriver.getCurrentUrl();
		assertEquals("https://www.atlantbh.com/category/big-data/", url);
		
		//da klikne na bilo koji link na svijetu
		...
		assertEquals("https://www.atlantbh.com/category/big-data/", url2);
