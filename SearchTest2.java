...
//		options.addArguments("--user-data-dir=C:\\Users\\user\\Desktop\\BURCH\\II semester");
	...
	void test() throws InterruptedException {
		...
		assertEquals("122 results found", text);
		
		String url = webDriver.getCurrentUrl();
		assertEquals("https://www.atlantbh.com/?s=development", url);
		
		Action clickLink = builder
				.moveToElement(webDriver.findElement(By.linkText("Service – Software Development"))).click()
				.pause(Duration.ofSeconds(3))
				.build();
		...
		assertEquals("https://www.atlantbh.com/service-software-development/", url2);
